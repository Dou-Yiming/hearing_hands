...
class LatentDiffusionMAA2CFGExpand(DDPM):
    """main class"""
    def __init__(self,
                 first_stage_config,
                 cond_stage_config,
    ...
    def get_input(self, batch, k, return_first_stage_outputs=False, force_c_encode=False,
        ...
        x_uncond = batch['uncond_mel'][:bs].to(self.device)
        encoder_posterior_uncond = self.encode_first_stage(x_uncond)
        z_uncond = self.get_first_stage_encoding(encoder_posterior_uncond).detach()
        ...
        if train:
            ...
            z = torch.where(video_feat_mask, z, z_uncond)
